...
## News and Updates
* ```2023.01.26``` 🎉🎉🎉 The [evaluation code](./evaluation/) of **InternLM-XComposer2-VL-7B** are publicly available.
...
* ```2023.01.26``` 🎉🎉🎉 We release a [technical report](./InternLM-XComposer2-Report.pdf) for more details of InternLM-XComposer2 series.
